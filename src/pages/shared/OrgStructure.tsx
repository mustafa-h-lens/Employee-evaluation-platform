                      ...
                      >
                        ...
                        <div className="ladder-dot relative z-10 flex-shrink-0 mt-1.5">
                          {isDir ? (
                            ...
                            // Regular titles — solid dept color with a
                            // subtle dept-tinted glow that adds depth in
                            // dark mode without going pale in light. The
                            // gradient (dot→gradFrom) keeps within the
                            // same color family so the dot still reads
                            // as a single solid hue, just with internal
                            // shading. White inner highlight tones down
                            // to 0.4 opacity so it reads as a "shine"
                            // instead of a bullseye.
                            <div
                              className="w-5 h-5 rounded-full ring-2 ring-white flex items-center justify-center"
                              style={{
                                background: `linear-gradient(135deg, ${c.dot}, ${c.gradFrom})`,
                                boxShadow: `0 0 10px ${c.dot}55, 0 1px 2px rgba(0,0,0,0.15)`,
                              }}
                            >
