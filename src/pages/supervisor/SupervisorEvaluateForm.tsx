  ...
  if (noAssignment) {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-ds-text">التقييم كمشرف</h1>
  ...
  if (!employeeId) {
    return (
      <div className="space-y-6">
        ...
        >
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold" style={{ color: 'var(--sc-green-val)' }}>التقييم كمشرف</h1>
